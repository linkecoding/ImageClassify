...
/**
 * Created by 尚振鸿 on 2017/6/16. 16:39
 * mail:szh@codekong.cn
 */

public class CompositionAvatarUtil {

    public static void asyncLoadDrawable(CompositionAvatarView view, List<String>imgUrlList) {
        int length = Math.min(imgUrlList.size(), CompositionAvatarView.MAX_DRAWABLE_COUNT);
