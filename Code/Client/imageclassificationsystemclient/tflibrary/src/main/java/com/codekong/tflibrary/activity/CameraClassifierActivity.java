...
import com.codekong.tflibrary.customview.OverlayView;
import com.codekong.tflibrary.customview.ResultsView;
import com.codekong.tflibrary.env.BorderedText;
import com.codekong.tflibrary.env.ImageUtils;
import com.codekong.tflibrary.env.Logger;
...
public class CameraClassifierActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    public CameraClassifierActivity() {
        //构造函数给模型文件路径常量赋值
