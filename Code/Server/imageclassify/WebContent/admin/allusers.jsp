...
<html lang="en"> 
  ...
  <body>
    ...
    <section>
      ...
      <div class="mainpanel">
        ...
        <div class="pageheader">
          <h2>
            <i class="glyphicon glyphicon-user"></i>所有用户
            <span>查看和管理所有用户</span>
            </h2>
        </div>
            ...
            <div class="people-item">
              <div class="media">
                ...
                <div class="media-body">
                  <h4 class="person-name">用户名</h4>
                  <div class="text-muted">
                  <i class="fa fa-mobile-phone"></i>15161161067</div>
                  <div class="text-muted">
                  <i class="fa fa-money"></i>1200</a>
                  </div>
                  <div class="text-muted">
                  <i class="fa fa-hand-o-right"></i>56%</a>
                  </div>
                  <ul class="social-list">
                    <li><a href="" class="tooltips" data-toggle="tooltip" data-placement="top" title="" data-original-title="冻结用户"><i class="fa fa-times-circle-o"></i></a></li>
                    <li><a href="" class="tooltips" data-toggle="tooltip" data-placement="top" title="" data-original-title="修改用户信息"><i class="fa fa-pencil"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
    ...
    <script src="customejs/allusers.js"></script>
  </body>
</html>