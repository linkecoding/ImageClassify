...
<html lang="en">
  ...
  <body>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                     <input id="category_input" type="text" name="name" class="form-control" placeholder="请输入分类" required="">
                  </div>
                  <button id= "add_category" class="btn btn-success">添加分类</button>
                </div>
              </div><!-- panel-body -->
            </div>
              ...
              <div class="panel-heading">
                <h4 class="panel-title">已有分类</h4>
                <p>管理员可点击下面分类，下载对应分类下的图片</p>
              </div>
            <div id = "all_category_div" style="margin-top:5px;">
              </div>
              </div><!-- panel-body -->
          </div>
        </div>
    ...
    <script src="customejs/addcategory.js"></script>
  </body>
</html>